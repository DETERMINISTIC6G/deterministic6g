...
INET’s components or plan to extend INET with new protocols or other components using C++, we
recommend the :doc:`Deterministic6G Developer's Guide </developers-guide/index>`.)
