...
COPY . /root/models/deterministic6g
...
WORKDIR /root/models/deterministic6g
COPY --from=d6gbuilder /root/models/deterministic6g/ .

RUN /root/omnetpp/ide/omnetpp -nosplash -data /root/models -application org.eclipse.cdt.managedbuilder.core.headlessbuild -import /root/models/deterministic6g
